...
Game::Game() : win(640,480,"Djenga",45,1.0,-1.0),ball (0.1, Vector(0,0,-0.3), Vector(0.5,0.13,0)) {
   initializeGL();
}
...
void Game::connectToInputs(const std::string& bluetoothAddr, const std::string& wandAddr){

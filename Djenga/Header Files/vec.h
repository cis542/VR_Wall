...
/*
const double M_PI_2 = (3.14159265358979323846f)/2.0f;				// PI/2
const double M2_PI = (3.14159265358979323846f)*2.0f;				// PI*2
const double Rad2Deg = 180.0f / (3.14159265358979323846f);			// Rad to Degree
const double Deg2Rad = (3.14159265358979323846f) / 180.0f;			// Degree to Rad
*/
...
// double and takes as aPIrgument a double
